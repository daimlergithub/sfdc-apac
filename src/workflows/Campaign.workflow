...
&apos;L2&apos;+&quot;_&quot;+TEXT(YEAR(DATEVALUE(CreatedDate)))+&quot;_&quot;+Auto_Number__c)</formula>
    ...
    <outboundMessages>
        ...
        <endpointUrl>https://crm-salesforce.mercedes-benz.com/webservices/CampaignUpdateNotification</endpointUrl>
        <fields>Id</fields>
        <fields>MD__c</fields>
        <includeSessionId>false</includeSessionId>
        <integrationUser>deployment.user@mbj.daimler-apac.com</integrationUser>

...
<Profile xmlns="http://soap.sforce.com/2006/04/metadata">
    ...
    <fieldPermissions>
        <editable>false</editable>
        <field>Retail_Task__c.Related_Dealer_Outlet_name__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>false</editable>
    ...
    <layoutAssignments>
        <layout>Account_Link__c-Person Retail Copy - Copy</layout>
    ...
    <layoutAssignments>
        <layout>Complaints__kav-Complaints Layout</layout>
    </layoutAssignments>
    <layoutAssignments>
    ...
    <layoutAssignments>
        <layout>Contacts__kav-Contacts Layout</layout>
    </layoutAssignments>
    <layoutAssignments>
    ...
    <layoutAssignments>
        <layout>Field_History__kav-Field History Layout</layout>
    </layoutAssignments>
    <layoutAssignments>
    ...
    <layoutAssignments>
        <layout>Question__kav-Question Layout</layout>
    </layoutAssignments>
    <layoutAssignments>

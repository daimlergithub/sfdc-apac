...
<CustomApplication xmlns="http://soap.sforce.com/2006/04/metadata">
    <actionOverrides>
        ...
        <content>Opportunity_Sales_Record_PageLTG</content>
    ...
    <actionOverrides>
        ...
        <content>Account_Record_Page_ANZ_LTG</content>
        <formFactor>Large</formFactor>
        <skipRecordTypeSelect>false</skipRecordTypeSelect>
        <type>Flexipage</type>
    ...
    <profileActionOverrides>
        <actionName>View</actionName>
        <content>Opportunity_AfterSales_Record_PageLTG</content>
        <formFactor>Large</formFactor>
        <pageOrSobjectType>Opportunity</pageOrSobjectType>
        <recordType>Opportunity.Aftersales_Lead</recordType>
        <type>Flexipage</type>
        <profile>Base CRM LTG</profile>
    </profileActionOverrides>

...
<Profile xmlns="http://soap.sforce.com/2006/04/metadata">
    ...
    <layoutAssignments>
        <layout>Account-Company Layout%28Dealer%29</layout>
        <recordType>Account.Company</recordType>
    </layoutAssignments>
    <layoutAssignments>
        <layout>Account-Dealer Layout-Retail</layout>
    ...
    <layoutAssignments>
        <layout>Contact-Contact Layout%28Dealer%29</layout>
    ...
    <layoutAssignments>
        <layout>Event-Event Layout Retail</layout>
    </layoutAssignments>
    <layoutAssignments>
    ...
    <layoutAssignments>
        <layout>PersonAccount-Person Account%28Dealer%29</layout>
    ...
    <layoutAssignments>
        <layout>PreOrder__c-Pre-Order Layout%28Retail%29</layout>
    </layoutAssignments>
    <layoutAssignments>
    ...
    <layoutAssignments>
        <layout>Retail_Task__c-Retail Task Layout%28ContractDealer%29</layout>
        <recordType>Retail_Task__c.Contract</recordType>
    </layoutAssignments>
    <layoutAssignments>
        <layout>Retail_Task__c-Retail Task Layout%28ServiceDealer%29</layout>
    ...
    <layoutAssignments>
        <layout>Task-Change Owner Layout Retail</layout>
    ...
    <layoutAssignments>
        <layout>Task-EOC Call Task Layout</layout>
        <recordType>Task.EOC_Call</recordType>
    </layoutAssignments>
    <layoutAssignments>
        <layout>Task-General Task Layout Retail</layout>

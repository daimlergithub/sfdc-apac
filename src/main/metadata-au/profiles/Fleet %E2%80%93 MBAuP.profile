...
<Profile xmlns="http://soap.sforce.com/2006/04/metadata">
    ...
    <layoutAssignments>
        <layout>Lead_Product__c-Customer Contact Layout</layout>
    ...
    <layoutAssignments>
        <layout>Lead_Product__c-Order Layout</layout>
        <recordType>Lead_Product__c.Order</recordType>
    </layoutAssignments>
    <layoutAssignments>
        <layout>Lead_Product__c-Quote Layout</layout>
    ...
    <layoutAssignments>
        <layout>Vehicle_Relationship__c-Company Vehicle Relationship Layout with locked%2Fread-only fields</layout>
    </layoutAssignments>
    <layoutAssignments>
        <layout>Vehicle_Relationship__c-Company Vehicle Relationship Layout with locked%2Fread-only fields</layout>
    ...
    <layoutAssignments>
        <layout>Vehicle_Relationship__c-Individual Vehicle Relationship Layout with locked%2Fread-only fields</layout>
